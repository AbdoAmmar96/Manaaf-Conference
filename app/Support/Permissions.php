...
class Permissions
{
    ...
    public static function matrix(): array
    {
        return [
            ...
            'guests_approve' => [
                'title' => 'اعتماد طلبات الحضور',
                'description' => 'مراجعة الطلبات القادمة من الموقع واعتمادها أو رفضها، وإرسال بطاقة الدعوة.',
                'roles' => ['admin', 'reception'],
            ],
            'guests_delete' => [
                'title' => 'حذف الضيف',
                'description' => 'حذف سجل ضيف نهائيًا — للمدير وحده، واهتماماته المسجّلة تبقى محفوظة باسمه.',
                'roles' => ['admin'],
            ],
            'zones' => [
            ...
            'projects' => [
                'title' => 'المشاريع',
                'description' => 'إضافة المشاريع وتعديلها وربطها بمجالات الاهتمام.',
                'roles' => ['admin'],
            ],
            'interests' => [
                'title' => 'مجالات الاهتمام',
                'description' => 'إضافة مجالات الاهتمام وتعديلها وتعطيلها وربطها بالمشاريع.',
                'roles' => ['admin'],
            ],
            'users' => [
